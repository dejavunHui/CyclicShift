...
# Miscss
parser.add_argument('--manualSeed', type=int, help='manual seed', default=2021)
...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_loss, train_acc = train(train_loader, model, criterion, optimizer, epoch, use_cuda, KL)
...
def train(trainloader, model, criterion, optimizer, epoch, use_cuda, KL):
