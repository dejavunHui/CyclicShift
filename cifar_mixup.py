...
def train(trainloader, model, criterion, optimizer, epoch, use_cuda):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        prec1, prec5 = accuracy(outputs.data, targets_a.data, topk=(1, 5))
        prec1_, prec5_ = accuracy(outputs.data, targets_b.data, topk=(1, 5))
        prec1 = lam * prec1 + (1 - lam) * prec1_
        prec5 = lam * prec5 + (1 - lam) * prec5_
